...
- This Dockerfile is a fork of [official nifi Docker image](https://github.com/apache/nifi/tree/rel/nifi-1.18.0/nifi-docker/dockerhub)
- Add Dremio and PostgreSQL drivers
- Add get-text package fro envsubst
- Add python package for installing via pip requirements.txt
